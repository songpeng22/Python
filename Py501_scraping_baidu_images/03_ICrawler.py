...
#必应图片爬虫
bing_storage = {'root_dir': 'E:\\Python\\Py501_scraping_baidu_images\\ICrawlerImages\\bing'}
...
#百度图片爬虫
baidu_storage = {'root_dir': 'E:\\Python\\Py501_scraping_baidu_images\\ICrawlerImages\\baidu'}
...
#谷歌图片爬虫
google_storage = {'root_dir': 'E:\\Python\\Py501_scraping_baidu_images\\ICrawlerImages\\google'}
...
my_storage = {'root_dir': 'E:\\Python\\Py501_scraping_baidu_images\\ICrawlerImages\\images'}
my_crawler = MyCrawler(parser_threads=4, 
                                downloader_threads=4, 
                                storage=my_storage)
my_crawler.crawl(keyword='Flufloxacin', 
                     max_num=200)
